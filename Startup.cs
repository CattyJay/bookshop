...
using KursivProject.Data.Mocks;
...
using KursivProject.Data.Repository;
using KursivProject.Data.Models;

namespace KursivProject
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMvc(route =>
            {
                ...
                route.MapRoute(name: "categoryFilter", template: "Book/{action}/{category?}", defaults: new { Controller="Book", action="List"});
            });
